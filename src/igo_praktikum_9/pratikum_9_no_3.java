...
public class pratikum_9_no_3 {
    ...
    public static void main(String[] args) {
        ...
        nilai[0] = 23; // mendeklarasikan array nilai yaitu index ke 0
        nilai[1] = 50; // mendeklarasikan array nilai yaitu index ke 1
        nilai[2] = 34; // mendeklarasikan array nilai yaitu index ke 2
        nilai[3] = 78; // mendeklarasikan array nilai yaitu index ke 3
        nilai[4] = 90; // mendeklarasikan array nilai yaitu index ke 4
