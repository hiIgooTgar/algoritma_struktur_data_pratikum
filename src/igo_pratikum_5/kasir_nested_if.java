...
public class kasir_nested_if {
    ...
    public static void main(String[] args) {
        ...
        if(kartu.equalsIgnoreCase("ya")) {
            if(belanjaan > 500000) {  // jika punya kartu member dan belanjaan lebih dari 500000 maka mendapatkan diskon Rp. 50000
                diskon = 50000;
            } else if(belanjaan > 100000) { // jika punya kartu member dan belanjaan lebih dari 100000 maka mendapatkan diskon Rp. 15000
                diskon = 15000;
            } else {  // jika punya kartu member dan belanjaan kurang dari 100000 tidak mendapatkan diskon
                diskon = 0;
            }
        } else {
            if(belanjaan > 100000) { // jika tidak punya kartu member dan belanjaan lebih dari 100000 maka mendapatkan diskon Rp. 5000
                diskon = 5000;
        ...
        // cetak diskon dengan memanggil variabel diskon
