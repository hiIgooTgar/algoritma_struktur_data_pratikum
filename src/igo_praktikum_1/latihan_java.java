...
public class latihan_java {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Nama : Igo Tegar Prambudhy");
        System.out.println("NIM : 24SA11A159");
        System.out.println("Program Studi : Informtika");
